...
1. A Disco Elysium Style Conversation, Dialogue Reel to talk with NPCs.
2. Point of Interest Barks.
3. 24 Internal Phycological Aspects to converse with (feat Disco Elysium)
4. Combat (Hades Style) with 5 unique weapons, items for heal.
5. Enemy Characters. Three Patrolling Intelligent Enemy AI Types which chases and attacks Player when approached. Enemy animations.
6. Health Bar and Healing.
7. NPC conversations.
